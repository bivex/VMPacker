...
#define VM_SECTIONS_H
    ...
    /* Mach-O section syntax: "__SEGMENT,__section" */
    #define VM_SECTION_ALU     __attribute__((section("__TEXT,__text")))
    #define VM_SECTION_MEM     __attribute__((section("__TEXT,__text")))
    #define VM_SECTION_BRANCH  __attribute__((section("__TEXT,__text")))
    #define VM_SECTION_SYSTEM  __attribute__((section("__TEXT,__text")))
  #else
